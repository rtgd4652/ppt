...
def main() -> None:
    tech = ROOT / "mod/common/technology/aemusa_technology.txt"
    for key in [
    ...
    buildings = ROOT / "mod/common/buildings/aemusa_buildings.txt"
    for key in [
    ...
    districts = ROOT / "mod/common/districts/aemusa_districts.txt"
    for key in [
    ...
    armies = ROOT / "mod/common/armies/aemusa_artifact_armies.txt"
    ...
    set_top_block_icon(
        ROOT / "mod/common/governments/civics/aemusa_origins.txt",
        "origin_artifact_resonance",
        '"gfx/interface/icons/origins/origin_artifact_resonance.dds"',
    )
    set_top_block_icon(
        ROOT / "mod/common/decisions/aemusa_destiny_city_decisions.txt",
        "decision_artifact_destiny_city_project",
        "decision_artifact_destiny_city_project",
    )

    edicts = ROOT / "mod/common/edicts/00_simple_leader_edict.txt"
    ...
    base_sets = ROOT / "mod/common/component_sets/aemusa_component_sets.txt"
    for key, icon in {
    ...
    tier_sets = ROOT / "mod/common/component_sets/aemusa_tiered_component_sets.txt"
    for key, icon in {
    ...
    for key, icon in base_component_icons.items():
        set_keyed_block_icon(ROOT / "mod/common/component_templates/aemusa_artifact_components.txt", key, f'"{icon}"')
    ...
    for key, icon in tier_component_icons.items():
        set_keyed_block_icon(ROOT / "mod/common/component_templates/aemusa_artifact_tiered_components.txt", key, f'"{icon}"')
